module.exports = function(nw) {
    ...
    function responseParser(response) {
        ...
        if (result.header["content-type"].indexOf("application/json") > -1 && typeof response.body === "string") {
            try {
            ...
            result.body = parseFormUrlencoded(response.body) || {};
        }
        else {
            result.body = response.body || {};
        }
